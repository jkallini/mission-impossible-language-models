...
from utils import CHECKPOINT_PATH, PERTURBATIONS, get_gpt2_tokenizer_with_markers
...
if __name__ == "__main__":
    ...
    file = directory + f"/{args.pooling_operation}_pooling_seed{args.random_seed}.csv"
